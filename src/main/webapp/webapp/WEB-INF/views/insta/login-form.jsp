   ...
   <div class="center" id="container">
      <div class="center" id="main">
         <div id="top" style="width:340px">
            <div id="title">
               <h1>lxtagram</h1>
	            ...
	            <input class="input-field" id="id-input" type="text" name="memId" placeholder="사용자이름(ID)">
	            <input class="input-field" id="pw-input" type="password" name="memPw" placeholder="비밀번호">
         ...
         <div class="center" id="bottom">
            <div id="existing-user">계정이 없으신가요? <a class="blue-text" href="signup-form.do">회원가입</a>
            </div>
            <div>앱을 다운로드하세요.</div>
            <div class="dl-links">
      ...
      <div id="links">
         ...
         <div id="copyright">
            ...
            &copy; 2021 Spting Team2 Lxtagram 
         </div>
      </div>
   </div>

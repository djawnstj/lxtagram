			...
			<nav
				...
				<section class="inner">
					...
					<div id="icons" class="d-flex align-items-center">
						<a class="rightitmes1" href="post-upload.do"> <img
							class="icons" src="resources/img/post.png" alt="post"
							style="height: 30px;">
						</a> <a class="rightitmes2" href="#"> <img class="icons"
							src="resources/img/explore.png" alt="explore"
							style="height: 30px;">
						</a> <a class="rightitmes3" href="#"> <img class="icons"
							src="<%=vo.memImg%>" alt="explore" style="height: 30px;">
						</a>
					</div>
				</section>
			</nav>
